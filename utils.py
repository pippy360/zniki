...
def isValidUsername(username):
	...
	if len(username) > MAX_EMAIL_SIZE:
		return {'isValid':False, 'reason':'Username was more than '+str(MAX_EMAIL_SIZE)+' characters'}

	if len(username) < MAX_EMAIL_SIZE:
		return {'isValid':False, 'reason':'Username was lass than '+str(MIN_EMAIL_SIZE)+' characters'}
